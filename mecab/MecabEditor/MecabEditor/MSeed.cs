...
namespace MecabEditor
{
    ...
    public class MSeed
    {
        ...
        public MSeed()
        {
            ...
            dicMembers.Add(XmlDatas.ListItemNames["LEFT_CONNECT_STATUS_NO"], 1000);
            dicMembers.Add(XmlDatas.ListItemNames["RIGHT_CONNECT_STATUS_NO"], 1000);
            dicMembers.Add(XmlDatas.ListItemNames["COST"], 1000);
        ...
        public Boolean getFromCsvFile(String strLine)
        {
            ...
            dicMembers[XmlDatas.ListItemNames["LEFT_CONNECT_STATUS_NO"]] = 1000;
            dicMembers[XmlDatas.ListItemNames["RIGHT_CONNECT_STATUS_NO"]] = 1000;
            dicMembers[XmlDatas.ListItemNames["COST"]] = 1000;
        ...
        //Csvファイルから読み取り
        public Boolean getFromCsvFile2(String strLine)
        {
            Boolean bResult = false;
            ...
            dicMembers[XmlDatas.ListItemNames["SEED_NO"]] = 0;
            dicMembers[XmlDatas.ListItemNames["HYOSO_TYPE"]] = strLineSplitComma[0];
            dicMembers[XmlDatas.ListItemNames["LEFT_CONNECT_STATUS_NO"]] = 1000;
            dicMembers[XmlDatas.ListItemNames["RIGHT_CONNECT_STATUS_NO"]] = 1000;
            dicMembers[XmlDatas.ListItemNames["COST"]] = 1000;
            dicMembers[XmlDatas.ListItemNames["HINSHI"]] = strLineSplitComma[1];
            dicMembers[XmlDatas.ListItemNames["HINSHI_DETAIL_1"]] = strLineSplitComma[2];
            dicMembers[XmlDatas.ListItemNames["HINSHI_DETAIL_2"]] = strLineSplitComma[3];
            dicMembers[XmlDatas.ListItemNames["HINSHI_DETAIL_3"]] = strLineSplitComma[4];
            dicMembers[XmlDatas.ListItemNames["KATSUYO_KEI"]] = strLineSplitComma[5];
            dicMembers[XmlDatas.ListItemNames["KATSUYO_TYPE"]] = strLineSplitComma[6];
            dicMembers[XmlDatas.ListItemNames["BASE_TYPE"]] = strLineSplitComma[7];
            dicMembers[XmlDatas.ListItemNames["YOMI"]] = strLineSplitComma[8];
            dicMembers[XmlDatas.ListItemNames["HATSUON"]] = strLineSplitComma[9];
            dicMembers[XmlDatas.ListItemNames["CREATED_AT"]] = DateTime.Now;
            dicMembers[XmlDatas.ListItemNames["UPDATED_AT"]] = DateTime.Now;
            dicMembers[XmlDatas.ListItemNames["DELETE_FLAG"]] = 0;
            dicMembers[XmlDatas.ListItemNames["DATA_COUNT"]] = 1;
